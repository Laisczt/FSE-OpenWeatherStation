...
| :--- | :--- | :--- | :--- | :--- | :--- | :---: |
| **Open Weather Station** | Medir, monitorar, armazenar dados e enviá-los para servidores próprios ou redes meteorológicas | Temperatura, Umidade, Pressão, Luminosidade, Pluviometria, Anemometria | Bluetooth + Wi-Fi + rede móvel 4G | USB + Power Bank (backup) + suporte a painel solar | Hardware e software open source, totalmente personalizáveis | ~400 |
